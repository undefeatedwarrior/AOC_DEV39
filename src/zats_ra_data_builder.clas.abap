CLASS zats_ra_data_builder DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zats_ra_data_builder IMPLEMENTATION.
...
*        output =
  ...
  METHOD fill_master_data.
    data : lt_bp type table of zats_ra_bpa,
           lt_prod type table of zats_ra_product.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zats_ra_bpa from table @lt_bp.
     insert zats_ra_product from table @lt_prod.
  ENDMETHOD.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lt_so type table of zats_ra_so_hdr,
           lt_so_i type table of zats_ra_so_item.
    ...
    select * from zats_ra_bpa into table @data(lt_bpa).
    select * from zats_ra_product into table @data(lt_prod).
    ...
    insert zats_ra_so_hdr from table @lt_so.
    insert zats_ra_so_item from table @lt_so_i.

  ENDMETHOD.

  METHOD flush.
    delete from : zats_ra_bpa, zats_ra_product, zats_ra_so_hdr, zats_ra_so_item.
  ENDMETHOD.
